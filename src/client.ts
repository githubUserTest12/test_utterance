...
if (script === undefined) {
  ...
  script = document.querySelector('script[src^="http://http://104.211.57.0/client.js"],script[src^="http://localhost:4000/client.js"]') as HTMLScriptElement;
}
...
const utterancesOrigin = script.src.match(/^http:\/\/104.211.57.0|http:\/\/localhost:\d+/)![0];
